...
module ActiveRecord
  ...
  module Associations # :nodoc:
    ...
    private
      ...
      #
      # In the following list, we assume a deprecated association:
      #
      ...
      #
      # If present (it is optional), this has to be a hash with keys +:mode+
      # and/or +:backtrace+.
      #
      # ==== Mode
      #
      ...
      # ==== Backtrace
      #
      # If :backtrace is true, warnings include a clean backtrace in the
      # message, exceptions have a clean backtrace, and notifications have a
      # +:backtrace+ key in the payload with an array of clean
      ...
      module ClassMethods
        ...
        # [+:deprecated+]
        #   If true, marks the association as deprecated. By default, usage of deprecated associations triggers warnings. Please check the documentation above for details.
        #
        # Option examples:
